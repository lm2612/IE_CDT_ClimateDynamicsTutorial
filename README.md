...
Imagine you work for the Met Office and a client (e.g., from agriculture, utilities companies, finance) has asked you predict the temperature in the UK on 19th November 2025 and on 19th November 2100. You have access to data from climate model simulations (CMIP), but you can use data from other sources if you wish. The different timescales require different approaches.
